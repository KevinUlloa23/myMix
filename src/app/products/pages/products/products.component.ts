...
export class ProductsComponent implements OnInit {
   ...
   ELEMENT_DATA: PeriodicElement[] = [
    ...
    {brandName: 'double edited', productId: 12, productName: 'Cowboy Burger',      SKU: 'mnblkajsy6ytqj323js3r3jb', price: 6.99, status: 'active'},
    {brandName: 'double edited', productId: 13, productName: 'Itallian Special',   SKU: 'msdfbsjdhfglkjas9893bja6', price: 6.99, status: 'active'},
    {brandName: 'double edited', productId: 14, productName: 'Buffalo Chicken',    SKU: 'a,nmbsmnabsddkqjuyyqe223', price: 4.99, status: 'active'},
    {brandName: 'double edited', productId: 15, productName: 'Chicken Salad',      SKU: 'lalaksjshte23us8basgasd3', price: 2.99, status: 'active'},
    {brandName: 'double edited', productId: 16, productName: 'Wing Combos',        SKU: 'asd3215asdnnusd8adhafag8', price: 3.99, status: 'active'},
    {brandName: 'double edited', productId: 17, productName: '10 Wings',           SKU: 'nd342567aerewquyeopnashd', price: 9.99, status: 'active'},
    {brandName: 'double edited', productId: 18, productName: 'Small Cake',         SKU: 'asdmfbj83e4efjksgdf32hsd', price: 7.99, status: 'active'},
